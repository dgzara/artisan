...
class BasesfGuardUserAdminForm extends BasesfGuardUserForm
{
  ...
  public function setup()
  {
    ...
    $this->mergePostValidator(new sfValidatorSchemaCompare('password', sfValidatorSchemaCompare::EQUAL, 'password_again', array(), array('invalid' => 'Las dos contraseñas deben ser las mismas.')));
  }
}