...
class TCPDF {
	...
	public function Footer() {
                $this->writeHTML('<div align="right"><font size="12"><br><br>______________________<br>FIRMA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><br><br><br></div>' , true, 0);
		$cur_y = $this->y;
		$this->SetTextColor(0, 0, 0);
		...
		if ($this->getRTL()) {
			...
			$this->Cell(0, 0, $pagenumtxt, 'T', 0, 'R');
                ...
                //$this->Cell(0, 0, "KKKKLKL", 'T', 0, 'R');
                //$this->writeHTML("<font='15'>__________________<br>AAAAAAAAAAAAAH</font>" , true, 0);
	}
