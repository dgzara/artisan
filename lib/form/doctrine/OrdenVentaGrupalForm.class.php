 ...
 */
class OrdenVentaGrupalForm extends BaseOrdenVentaForm
{
  public function configure()
  {
    ...
    $this->getWidgetSchema()->moveField('fecha', sfWidgetFormSchema::AFTER, 'numero');
    $this->getWidgetSchema()->moveField('cliente_id', sfWidgetFormSchema::AFTER, 'fecha');
