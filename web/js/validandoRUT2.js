	...
	function valida() {
	 ...
	 rut_val = document.form.proveedor_empresa_rut.value;
	 clave = document.form.clave_aux.value;
	 if ( rut_val.length == 0 )
	 {
	  alert( "Ingrese su R.U.T.");
	  document.form.proveedor_empresa_rut.focus();
	  return false;
	 }
	 if ( clave.length == 0 )
	 {
	 ...
	 if ( !checkRutField(document.form.proveedor_empresa_rut.value) )
	 {
	  return false;
	 }
	 ...
	 if ( rut_valor > 50000000)
	 {
	  ...
	  document.form.proveedor_empresa_rut.value = "";
	...
	// [VARM-]
	 if ( largo < 2 )
	 {
	  ...
	  document.form.proveedor_empresa_rut.focus();
	  document.form.proveedor_empresa_rut.select();
	  return false;
	 }
	 for (i=0; i < largo ; i++ )
	 {
	 ...
	 document.form.proveedor_empresa_rut.value = invertido;
	 if ( checkDV(rut) )
	  return true;
	 return false;
	}
